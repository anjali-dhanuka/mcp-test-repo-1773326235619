...
let pullRequestTools: PullRequestTools;
...
server.tool('list_repositories', ListRepositoriesParamsSchema.shape, async (params) => {
  return await repositoryTools.listRepositories(params);
});

server.tool('get_repository', RepositoryParamsSchema.shape, async (params) => {
  return await repositoryTools.getRepository(params);
});

server.tool('create_repository', CreateRepositoryParamsSchema.shape, async (params) => {
  return await repositoryTools.createRepository(params);
});

server.tool('get_repository_clone_urls', RepositoryParamsSchema.shape, async (params) => {
  return await repositoryTools.getRepositoryCloneUrls(params);
});

server.tool('list_repository_contents', ListContentsParamsSchema.shape, async (params) => {
  return await repositoryTools.listRepositoryContents(params);
});

server.tool('get_repository_stats', RepositoryParamsSchema.shape, async (params) => {
  return await repositoryTools.getRepositoryStats(params);
});

// Issue Management Tools
server.tool('list_issues', ListIssuesParamsSchema.shape, async (params) => {
  return await issueTools.listIssues(params);
});

server.tool('get_issue', IssueParamsSchema.shape, async (params) => {
  return await issueTools.getIssue(params);
});

server.tool('create_issue', CreateIssueParamsSchema.shape, async (params) => {
  return await issueTools.createIssue(params);
});

server.tool('update_issue', UpdateIssueParamsSchema.shape, async (params) => {
  return await issueTools.updateIssue(params);
});

server.tool('add_issue_comment', CommentParamsSchema.shape, async (params) => {
  return await issueTools.addComment(params);
});

// Pull Request Management Tools
server.tool('list_pull_requests', ListPullRequestsParamsSchema.shape, async (params) => {
  return await pullRequestTools.listPullRequests(params);
});

server.tool('get_pull_request', PullRequestParamsSchema.shape, async (params) => {
  return await pullRequestTools.getPullRequest(params);
});

server.tool('create_pull_request', CreatePullRequestParamsSchema.shape, async (params) => {
  return await pullRequestTools.createPullRequest(params);
});

server.tool('update_pull_request', UpdatePullRequestParamsSchema.shape, async (params) => {
  return await pullRequestTools.updatePullRequest(params);
});

server.tool('merge_pull_request', MergePullRequestParamsSchema.shape, async (params) => {
  return await pullRequestTools.mergePullRequest(params);
});

server.tool('add_pull_request_comment', CommentParamsSchema.shape, async (params) => {
  return await pullRequestTools.addComment(params);
});

// File Operations Tools
server.tool('get_file_content', FileParamsSchema.shape, async (params) => {
  return await fileTools.getFileContent(params);
});

server.tool('create_file', CreateFileParamsSchema.shape, async (params) => {
  return await fileTools.createFile(params);
});

server.tool('update_file', UpdateFileParamsSchema.shape, async (params) => {
  return await fileTools.updateFile(params);
});

server.tool('delete_file', DeleteFileParamsSchema.shape, async (params) => {
  return await fileTools.deleteFile(params);
});

// User and Organization Tools
server.tool('get_user', UserParamsSchema.shape, async (params) => {
...
server.tool('get_organization', OrganizationParamsSchema.shape, async (params) => {
  return await userTools.getOrganization(params);
});

server.tool('list_user_repositories', {
  username: UserParamsSchema.shape.username,
  ...ListRepositoriesParamsSchema.shape
}, async (params) => {
  return await repositoryTools.listUserRepositories(params);
});

server.tool('list_organization_repositories', {
  org: OrganizationParamsSchema.shape.org,
  ...ListRepositoriesParamsSchema.shape
}, async (params) => {
...
// Search Tools
server.tool('search_repositories', SearchRepositoriesParamsSchema.shape, async (params) => {
  return await searchTools.searchRepositories(params);
});

server.tool('search_issues', SearchIssuesParamsSchema.shape, async (params) => {
  return await searchTools.searchIssues(params);
});

server.tool('search_code', SearchCodeParamsSchema.shape, async (params) => {
  return await searchTools.searchCode(params);
});

server.tool('search_users', SearchUsersParamsSchema.shape, async (params) => {
