...
export class IssueTools {
   ...
   */
  async listIssues(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(ListIssuesParamsSchema, params) as ListIssuesParams;
   ...
   */
  async getIssue(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(IssueParamsSchema, params) as IssueParams;
      validateGitHubParams({ 
        owner: validatedParams.owner, 
        repo: validatedParams.repo 
      });
   ...
   * Create a new issue
   */
  async createIssue(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(CreateIssueParamsSchema, params) as CreateIssueParams;
      validateGitHubParams({ 
        owner: validatedParams.owner, 
        repo: validatedParams.repo 
      });
   ...
   */
  async updateIssue(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(UpdateIssueParamsSchema, params) as UpdateIssueParams;
      validateGitHubParams({ 
        owner: validatedParams.owner, 
        repo: validatedParams.repo 
      });
   ...
   * Close an issue
   */
  async closeIssue(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(IssueParamsSchema, params) as IssueParams;
      validateGitHubParams({ 
        owner: validatedParams.owner, 
   ...
   * Reopen an issue
   */
  async reopenIssue(params: unknown): Promise<McpToolResult> {
    try {
      const validatedParams = validateParams(IssueParamsSchema, params) as IssueParams;
      validateGitHubParams({ 
        owner: validatedParams.owner, 
